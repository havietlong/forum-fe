               ...
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li class=" ">
                     ...
                     <ul id="mailbox" class="iq-submenu collapse" data-bs-parent="#iq-sidebar-toggle">
                        <li class="">
                           <a href="../app/email.html"><i class="  "></i>Đăng xuất</a>
                        </li>
                        <li class="">
                     ...
                     <div id="post-modal-data" class="card card-block card-stretch card-height">
                        ...
                        <div class="card-body">
                           ...
                           <ul class=" post-opt-block d-flex list-inline m-0 p-0 flex-wrap">
                              ...
                              <!-- <li class="me-3 mb-md-0 mb-2">
                                 <a href="#" class="btn btn-soft-primary">
                                    <img src="../assets/images/small/08.png" alt="icon" class="img-fluid me-2"> Tag Bạn
                                    bè
                                 </a>
                              </li> -->
                              <li class="me-3">
                                 <a href="#" class="btn btn-soft-primary">
                                    <img src="../assets/images/small/09.png" alt="icon" class="img-fluid me-2"> Cảm
                                    xúc/Hoạt động
                                 </a>
                              </li>
                              <li>
                              ...
                              <div class="modal-content">
                                 ...
                                 <div class="modal-body">
                                    ...
                                    <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                       ...
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                                src="../assets/images/small/08.png" alt="icon" class="img-fluid"> Tag
                                             Friend</div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                       ...
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                                src="../assets/images/small/10.png" alt="icon" class="img-fluid"> Check
                                             in</div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                                src="../assets/images/small/11.png" alt="icon" class="img-fluid"> Live
                                             Video</div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                                src="../assets/images/small/12.png" alt="icon" class="img-fluid"> Gif
                                          </div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                                src="../assets/images/small/13.png" alt="icon" class="img-fluid"> Watch
                                             Party</div>
                                       </li>
                                       <li class="col-md-6 mb-3">
                                          <div class="bg-soft-primary rounded p-2 pointer me-3"><a href="#"></a><img
                                                src="../assets/images/small/14.png" alt="icon" class="img-fluid"> Play
                                             with Friends</div>
                                       </li>
                                    </ul>
                                    <hr>
                     ...
                     <div class="card card-block card-stretch card-height">
                        <div class="card-body">
                              ...
                              <div class=" d-grid grid-rows-2 grid-flow-col gap-3">
                                 <div class="row-span-2 row-span-md-1">
                                    <a href="/dashboard/detail.html" target="_blank" rel="noopener noreferrer">
                                       <img src="../assets/images/page-img/a1.jpg" alt="post-image"
                                 ...
                                 <div class="row-span-1">
                                    <a href="/dashboard/detail.html" target="_blank" rel="noopener noreferrer">
                                       <img src="../assets/images/page-img/b1.jpeg" alt="post-image"
                                          class="img-fluid rounded w-100">
                                    </a>
                                 </div>

                                 <div class="row-span-1 ">
                                    <img src="../assets/images/page-img/c1.jpg" alt="post-image"
                                       class="img-fluid rounded w-100">
                                 </div>
                              </div>
                           </div>
                           <div class="comment-area mt-3">
                              ...
                              <hr>
                              <ul id="comments" class="post-comments list-inline p-0 m-0">
                                 <li class="mb-2" id="comment-1">
                                    <div class="d-flex">
                                       <div class="user-img">
                                       ...
                                       <div class="comment-data-block ms-3">
                                          <h6>Monty Carlo</h6>
                                          <p class="mb-0">Thời tiết dạo này se lạnh qua ôm em mà thấy phấn khởi quá làm
                                             luôn 2 nháy</p>
                                          <div class="d-flex flex-wrap align-items-center comment-activity">
                                             <a href="javascript:void();" class="reply-link"
                                                data-id="comment-1">reply</a>
                                             <span class="toggle-replies" data-id="comment-1">▼</span>
                                             <span> 5 min </span>
                                          </div>
                                       </div>
                                    </div>
                                    <div class="reply-box" id="replies-comment-1"></div>
                                 </li>
                              </ul>
                              <form class="comment-form" id="commentForm">
                                 <input type="text" id="commentInput" class="form-control rounded"
                           ...
                           <ul class="post-comments list-inline p-0 m-0">
                              <li class="mb-2">
                                 <div class="d-flex ">
                                    ...
                                    <div class="comment-data-block ms-3">
                                       <h6>Monty Carlo</h6>
                                       <p class="mb-0">Gặp em mọi thứ ưng ý, màn sevice nóng bỏng, em hôn rất nhiệt
                                          tình.</p>
                                       <div class="d-flex flex-wrap align-items-center comment-activity">

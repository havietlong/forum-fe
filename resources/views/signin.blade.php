                ...
                <div class="col-md-6 bg-white pt-5 pt-5 pb-lg-0 pb-5">
                    <div class="sign-in-from">
                        ...
                        <form class="mt-4">
                            ...
                            <div class="form-group">
                                <label class="form-label" for="exampleInputEmail2">Địa chỉ email</label>
                            ...
                            <div class="d-inline-block w-100">
                                <div class="form-check d-inline-block mt-2 pt-1">
                                    ...
                                    <label class="form-check-label" for="customCheck1">Tôi đồng ý <a href="#">Điều khoản và điều kiện</a></label>
                                </div>
                                <button type="submit" class="btn btn-primary float-end">Đăng kí</button>
                            </div>
                            <div class="sign-info">
                                <span class="dark-color d-inline-block line-height-2">Đã có tài khoản ? <a href="/login">Đăng nhập</a></span>
